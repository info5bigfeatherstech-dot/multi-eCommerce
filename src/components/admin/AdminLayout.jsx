  ...
  return (
    <div id="admin-panel" className="min-h-screen bg-slate-50 flex font-albert-sans text-slate-800">
      ...
      >
        ...
        {/* Sidebar Footer User Profile with Shadcn DropdownMenu */}
        <div className="p-3 border-t border-slate-100 bg-slate-50/80">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="w-full flex items-center justify-between p-1.5 rounded-xl hover:bg-slate-100 transition-colors text-left cursor-pointer group">
                <div className="flex items-center gap-2.5 min-w-0">
                  <Avatar className="w-9 h-9 rounded-xl border border-slate-200 shadow-2xs">
                    <AvatarImage src={adminUser?.avatar || "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=200&q=80"} alt="Admin Avatar" />
                    <AvatarFallback>{(adminUser?.name || "AD").slice(0, 2).toUpperCase()}</AvatarFallback>
                  </Avatar>
                  <div className="min-w-0">
                    <p className="text-xs font-poppins font-bold text-slate-900 truncate leading-tight group-hover:text-accent transition-colors">
            ...
            <DropdownMenuContent align="start" side="top" className="w-60 mb-2">
