...
export function HeroBanner() {
  ...
  if (status === "loading") {
    return (
      <div className="w-full h-[190px] sm:h-[280px] md:h-[350px] lg:h-[440px] rounded-2xl overflow-hidden shadow-sm border border-slate-200">
  ...
  return (
    <div className="w-full h-[190px] sm:h-[280px] md:h-[350px] lg:h-[440px] relative rounded-2xl overflow-hidden shadow-sm border border-slate-200/80 bg-slate-100">
