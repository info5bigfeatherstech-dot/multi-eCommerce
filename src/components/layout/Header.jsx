      ...
      <div className="w-full px-4 sm:px-6 py-2.5 flex items-center justify-between gap-3 lg:gap-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
          <button
            ...
            className="lg:hidden p-2 rounded-lg bg-primary-light/40 hover:bg-primary-light text-white focus:outline-none min-h-[44px] min-w-[44px] flex items-center justify-center cursor-pointer"
          >
        ...
        {/* Mobile Search Bar */}
        <div className="mt-1.5 md:hidden px-3 sm:px-6 pb-2.5">
          <SearchBar />
        </div>
